...
import com.dateyoureve.ashish.helloworld.materialcamera.util.Degrees;
import com.dateyoureve.ashish.helloworld.materialcamera.util.ImageUtil;
import com.dateyoureve.ashish.helloworld.materialcamera.util.ManufacturerUtil;

import static com.dateyoureve.ashish.helloworld.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static com.dateyoureve.ashish.helloworld.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static com.dateyoureve.ashish.helloworld.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static com.dateyoureve.ashish.helloworld.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static com.dateyoureve.ashish.helloworld.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_AUTO;
import static com.dateyoureve.ashish.helloworld.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_OFF;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  private static final String TAG = "CameraFragment";
    ...
    com.dateyoureve.ashish.helloworld.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new com.dateyoureve.ashish.helloworld.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof com.dateyoureve.ashish.helloworld.materialcamera.internal.CameraPreview)
