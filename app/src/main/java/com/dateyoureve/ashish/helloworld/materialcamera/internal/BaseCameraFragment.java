...
//    mButtonVideo = (ImageButton) view.findViewById(R.id.video);
    ...
    int primaryColor = getArguments().getInt(com.dateyoureve.ashish.helloworld.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR);
...
//              mDelayStartCountdown.setVisibility(View.GONE);
  ...
  protected final File getOutputMediaFile() {
    return CameraUtil.makeTempFile(
        getActivity(), getArguments().getString(com.dateyoureve.ashish.helloworld.materialcamera.internal.CameraIntentKey.SAVE_DIR), "VID_", ".mp4");
  }

  @NonNull
  protected final File getOutputPictureFile() {
    return CameraUtil.makeTempFile(
        getActivity(), getArguments().getString(com.dateyoureve.ashish.helloworld.materialcamera.internal.CameraIntentKey.SAVE_DIR), "IMG_", ".jpg");
  }
...
//    else if (id == R.id.video) {
      ...
      if (mIsRecording) {
        ...
        if (getArguments().getBoolean(com.dateyoureve.ashish.helloworld.materialcamera.internal.CameraIntentKey.SHOW_PORTRAIT_WARNING, true)
